...
class ColorButton(fantas.Label):
    ...
    def __init__(self, size, colors, mousewidget=ColorButtonMouseWidget, keywidget=ColorButtonKeyWidget, cancel_key='escape', **kwargs):
        super().__init__(size, colors['origin_bd'], colors['origin_bg'], None if 'origin_sc' not in colors else colors['origin_sc'], **kwargs)
        self.colors = colors
...
class CircleButton(fantas.CircleLabel):
    def __init__(self, radius, colors, bd=0, mousewidget=ColorButtonMouseWidget, keywidget=ColorButtonKeyWidget, cancel_key='escape', **kwargs):
        super().__init__(radius, colors['origin_bg'], bd, None if 'origin_sc' not in colors else colors['origin_sc'], **kwargs)
        self.colors = colors
        self.mousewidget = mousewidget(self)
        self.keywidget_class = keywidget
        self.mousewidget.apply_event()
